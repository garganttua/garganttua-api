 ...
 * the mint-side dual of the verify-side {@code .authenticate(...)}.
 *
 * @param <E> the authenticator entity type
 */
public interface IAuthenticatorAuthentication<E> {
    ...
    /** Returns to the parent authenticator builder. */
    IAuthenticatorBuilder<E> up();
