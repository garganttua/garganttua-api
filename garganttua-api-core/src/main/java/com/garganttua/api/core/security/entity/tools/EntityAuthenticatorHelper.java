...
public class EntityAuthenticatorHelper {
	...
	public static boolean isAuthenticator(Object entity) {
		...
		try {
			...
			log.atDebug().log("Error during determining if entity of type " + entity.getClass().getSimpleName()
					+ " is authenticator or not : " + e.getMessage());
			return false;
		}
		return infos != null;
	}
	...
	public static boolean isAuthenticator(Class<?> entityClass) {
		...
		try {
			...
			log.atDebug().log("Error during determining if entity of type " + entityClass.getSimpleName()
					+ " is authenticator or not : " + e.getMessage());
			return false;
		}
		return infos != null;
	...
	public static boolean isCreateAuthorization(Object entity) throws CoreException {
		...
		if (infos.authorizationType() != null && infos.authorizationType().getType() != void.class) {
			return true;
		}
		return false;
	}
