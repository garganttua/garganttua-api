...
public abstract class SignableAuthorization extends Authorization implements ISignableAuthorization {
	...
	public SignableAuthorization(byte[] raw) throws SecurityException {
		super(raw);
		this.signature = this.getSignatureFromRaw(raw);
	}

	public SignableAuthorization(String uuid, String id, String tenantId, String ownerUuid, List<String> authorities,
	...
	protected abstract byte[] getSignatureFromRaw(byte[] raw) throws SecurityException;
