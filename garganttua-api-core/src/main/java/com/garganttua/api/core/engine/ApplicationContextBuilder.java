...
public class ApplicationContextBuilder implements IApplicationContextBuilder {
	...
	public ApplicationContextBuilder autoDetect(boolean b) throws BuilderException {
		if( this.packages == null && b) {
			throw new BuilderException(CoreExceptionCode.BUILDER_CODE, "Packages must be set before setting autoDetect");
		}
		this.autoDetect = b;
		return this;
	}
	...
	@Override
	public IApplicationContextStartupBinderBuilder startup(ContextBuildingStage stage, IObjectSupplier<?> supplier) throws BuilderException {
		IApplicationContextStartupBinderBuilder binder = new ApplicationContextStartupBinderBuilder(this,  Objects.requireNonNull(supplier, "Supplier cannot be null"));
		this.startupBinderBuilders.add(binder);
		return binder;
	}

	@Override
	public IApplicationContextStartupBinderBuilder startup(ContextBuildingStage stage, Object object) throws BuilderException {
		IApplicationContextStartupBinderBuilder binder = new ApplicationContextStartupBinderBuilder(this,  Objects.requireNonNull(object, "Object cannot be null"));
		this.startupBinderBuilders.add(binder);
		return binder;
	}
	...
	public ApplicationContextBuilder superTenantAutoCreate(boolean b) throws BuilderException {
		if( this.superTenantId == null ) {
			throw new BuilderException(CoreExceptionCode.BUILDER_CODE, "Super tenant ID must be set before setting auto create");
		}
