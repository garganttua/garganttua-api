...
public abstract class Authorization implements IAuthorization {
	...
	@Override
	public void validateAgainst(IAuthorization authorizationReference, Object... args) throws SecurityException {
		this.isExpired();
		this.isRevoked();
	...
	@Override
	public void validate(Object... args) throws SecurityException {
		this.isExpired();
		this.isRevoked();
