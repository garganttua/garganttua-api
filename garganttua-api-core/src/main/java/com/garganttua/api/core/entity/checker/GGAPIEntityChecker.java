...
public class GGAPIEntityChecker {
	...
	public static GGAPIEntityInfos checkEntityClass(Class<?> entityClass) throws GGAPIException {
		...
		String saveProviderFieldAddress = GGAPIEntityChecker.getFieldAddressAnnotatedWithAndCheckType(entityClass,
				GGAPIEntitySaveMethodProvider.class, IGGAPIEntitySaveMethod.class, true);
		String deleteProviderFieldAddress = GGAPIEntityChecker.getFieldAddressAnnotatedWithAndCheckType(entityClass,
				GGAPIEntityDeleteMethodProvider.class, IGGAPIEntityDeleteMethod.class, true);
		String saveMethodAddress = GGAPIEntityChecker.getMethodAnnotationAndMethodParamsHaveGoodTypes(entityClass,
				GGAPIEntitySaveMethod.class, true, Object.class, IGGAPICaller.class,
				GGObjectReflectionHelper.getParameterizedType(Map.class, String.class, String.class));
		String deleteMethodAddress = GGAPIEntityChecker.getMethodAnnotationAndMethodParamsHaveGoodTypes(entityClass,
				GGAPIEntityDeleteMethod.class, true, void.class, IGGAPICaller.class,
				GGObjectReflectionHelper.getParameterizedType(Map.class, String.class, String.class));
		String repositoryFieldAddress = GGAPIEntityChecker.getFieldAddressAnnotatedWithAndCheckType(entityClass,
				GGAPIEntityRepository.class, IGGAPIRepository.class, true);
		String engineFieldAddress = GGAPIEntityChecker.getFieldAddressAnnotatedWithAndCheckType(entityClass,
				GGAPIEntityEngine.class, IGGAPIEngine.class, true);
		String gotFromReposiotryFieldAddress = GGAPIEntityChecker.getFieldAddressAnnotatedWithAndCheckType(entityClass,
				GGAPIEntityGotFromRepository.class, boolean.class, true);
		...
		Annotation hiddenableAnnotation = GGAPIEntityChecker.checkIfAnnotatedEntity(entityClass,
				GGAPIEntityHiddenable.class);
		Annotation geolocalizedAnnotation = GGAPIEntityChecker.checkIfAnnotatedEntity(entityClass,
				GGAPIEntityGeolocalized.class);
		...
		String afterGetm = GGAPIEntityChecker.getMethodAnnotationAndMethodParamsHaveGoodTypes(entityClass,
				GGAPIEntityAfterGet.class, false, void.class, IGGAPICaller.class,
				GGObjectReflectionHelper.getParameterizedType(Map.class, String.class, String.class));
		String beforeCreatem = GGAPIEntityChecker.getMethodAnnotationAndMethodParamsHaveGoodTypes(entityClass,
				GGAPIEntityBeforeCreate.class, false, void.class, IGGAPICaller.class,
				GGObjectReflectionHelper.getParameterizedType(Map.class, String.class, String.class));
		String afterCreatem = GGAPIEntityChecker.getMethodAnnotationAndMethodParamsHaveGoodTypes(entityClass,
				GGAPIEntityAfterCreate.class, false, void.class, IGGAPICaller.class,
				GGObjectReflectionHelper.getParameterizedType(Map.class, String.class, String.class));
		String beforeUpdatem = GGAPIEntityChecker.getMethodAnnotationAndMethodParamsHaveGoodTypes(entityClass,
				GGAPIEntityBeforeUpdate.class, false, void.class, IGGAPICaller.class,
				GGObjectReflectionHelper.getParameterizedType(Map.class, String.class, String.class));
		String afterUpdatem = GGAPIEntityChecker.getMethodAnnotationAndMethodParamsHaveGoodTypes(entityClass,
				GGAPIEntityAfterUpdate.class, false, void.class, IGGAPICaller.class,
				GGObjectReflectionHelper.getParameterizedType(Map.class, String.class, String.class));
		String beforeDeletem = GGAPIEntityChecker.getMethodAnnotationAndMethodParamsHaveGoodTypes(entityClass,
				GGAPIEntityBeforeDelete.class, false, void.class, IGGAPICaller.class,
				GGObjectReflectionHelper.getParameterizedType(Map.class, String.class, String.class));
		String afterDeletem = GGAPIEntityChecker.getMethodAnnotationAndMethodParamsHaveGoodTypes(entityClass,
				GGAPIEntityAfterDelete.class, false, void.class, IGGAPICaller.class,
				GGObjectReflectionHelper.getParameterizedType(Map.class, String.class, String.class));

		Map<String, String> updateAuthorizations = GGAPIEntityChecker.getFieldAuthorizedForUpdate(entityClass,
				new HashMap<String, String>());

		List<String> mandatoryFields = GGObjectReflectionHelper.getFieldAddressesWithAnnotation(entityClass,
				GGAPIEntityMandatory.class, true);
		...
		List<String> unicityFieldsTemp = GGObjectReflectionHelper.getFieldAddressesWithAnnotation(entityClass,
				GGAPIEntityUnicity.class, false);
		...
		try {
			if (tenantAnnotation != null) {
				tenantIdFieldAddress = GGAPIEntityChecker.checkAnnotationOrField(entityClass,
						GGAPIEntityChecker.getFieldAddressAnnotatedWithAndCheckType(entityClass,
								GGAPIEntityTenantId.class, String.class, false),
				...
				superTenantFieldAddress = GGAPIEntityChecker.checkAnnotationOrField(entityClass,
						...
						((GGAPIEntityTenant) tenantAnnotation).superTenant(), Boolean.class,
						GGAPIEntitySuperTenant.class);
			} else {
			...
			if (ownerAnnotation != null) {
				ownerIdFieldAddress = GGAPIEntityChecker.checkAnnotationOrField(entityClass,
						GGObjectReflectionHelper.getFieldAddressAnnotatedWithAndCheckType(entityClass,
								GGAPIEntityOwnerId.class, String.class),
			...
			if (hiddenableAnnotation != null) {
				hiddenFieldAddress = GGAPIEntityChecker.checkAnnotationOrField(entityClass,
						GGObjectReflectionHelper.getFieldAddressAnnotatedWithAndCheckType(entityClass,
								GGAPIEntityHidden.class, boolean.class),
						((GGAPIEntityHiddenable) hiddenableAnnotation).hidden(), boolean.class,
						GGAPIEntityHidden.class);
			}

			if (geolocalizedAnnotation != null) {
				locationFieldAddress = GGAPIEntityChecker.checkAnnotationOrField(entityClass,
						GGObjectReflectionHelper.getFieldAddressAnnotatedWithAndCheckType(entityClass,
								GGAPIEntityLocation.class, Point.class),
			...
			if (sharedAnnotation != null) {
				shareFieldAddress = GGAPIEntityChecker.checkAnnotationOrField(entityClass,
						GGObjectReflectionHelper.getFieldAddressAnnotatedWithAndCheckType(entityClass,
								GGAPIEntityShare.class, String.class),
		...
		try {
			...
			GGAPIEntityInfos entityInfos = new GGAPIEntityInfos(domain, q.address(uuidFieldAddress),
					...
					q.address(engineFieldAddress), mandatoryFields.stream().map(s -> {
						...
						try {
							return new Pair<GGObjectAddress, GGAPIUnicityScope>(q.address(p.getValue0()),
									p.getValue1());
						} catch (GGReflectionException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
	...
	private static Collection<Pair<String, GGAPIUnicityScope>> checkUnicitiesAnnotationPresent(Class<?> entityClass) {
		...
		if (annotation != null) {
			for (String unicity : annotation.unicities()) {
				unicities.add(new Pair<String, GGAPIUnicityScope>(unicity, GGAPIUnicityScope.tenant));
			}
		}
	...
	public static String getMethodAnnotationAndMethodParamsHaveGoodTypes(Class<?> entityClass,
			...
			Type... parameterTypes) throws GGAPIEntityException {
