...
public class Key implements IKey {
	...
	@Override
	public byte[] encrypt(byte[] clear) throws SecurityException {
		Cipher cipher;
		try {
	...
	@Override
	public byte[] decrypt(byte[] encoded) throws SecurityException {
		Cipher cipher;
		try {
			cipher = Cipher.getInstance(this.algorithm.geCipherName(this.encryptionMode, this.encryptionPaddingMode));
			if (this.initializationVector != null)
	...
	@Override
	public boolean verifySignature(byte[] signature, byte[] originalData) throws CoreException {
		String signatureName = this.algorithm.geSignatureName(this.signatureAlgorithm);
