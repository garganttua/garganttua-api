...
import com.garganttua.api.core.context.application.supplier.ExecutionContextObjectSupplier;
...
public class ExecutionContextObjectSupplierBuilder<Supplied>
    ...
    public IObjectSupplier<Supplied> build() throws CoreException {
        return new ExecutionContextObjectSupplier<>(this.supply, this.suppliedClass, IExecutionContext.class);
    }
