...
import com.garganttua.api.core.old.dao.DaosFactory;
...
public class DaosFactoryTest {
	...
	public void test() throws CoreException {
		...
		DaosFactory daf = new DaosFactory(domains, beanLoader);
		IDaosRegistry reg = daf.getRegistry();
