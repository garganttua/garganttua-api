...
class UpdateOneIntegrationTest extends AbstractCrudIntegrationTest {
    ...
    @Test
    @DisplayName("invoke updateOne workflow returns a successful response")
    void invokeUpdateOneWorkflow() throws ApiException {
        Operation updateOneOp = Operation.updateOneWithStandardSecurity("users", RuntimeClass.of(User.class));
        OperationRequest request = superTenantRequest(updateOneOp);
