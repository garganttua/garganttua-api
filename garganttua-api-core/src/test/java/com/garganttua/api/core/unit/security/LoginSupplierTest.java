...
import com.garganttua.api.core.security.authentication.LoginSupplier;
import com.garganttua.core.reflection.IClass;
import com.garganttua.core.runtime.IRuntimeContext;
import com.garganttua.core.supply.SupplyException;

@DisplayName("LoginSupplier Tests")
class LoginSupplierTest {
    ...
    class SupplyWithValidInput {
        ...
        @Test
        @DisplayName("returns callerId from caller")
        void returnsCallerId() throws SupplyException {
        ...
        void returnsEmptyWhenCallerIdNull() throws SupplyException {
            when(operationRequest.caller()).thenReturn(caller);
