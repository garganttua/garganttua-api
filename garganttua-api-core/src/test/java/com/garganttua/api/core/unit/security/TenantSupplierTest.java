...
import com.garganttua.api.core.security.authentication.TenantSupplier;
import com.garganttua.core.reflection.IClass;
import com.garganttua.core.runtime.IRuntimeContext;
import com.garganttua.core.supply.SupplyException;

@DisplayName("TenantSupplier Tests")
class TenantSupplierTest {
    ...
    private TenantSupplier supplier;
    ...
    class SupplyWithValidInput {
        ...
        @Test
        @DisplayName("returns tenantId from caller")
        void returnsTenantId() throws SupplyException {
            ...
            assertEquals("TENANT_1", result.get());
        }
        ...
        void returnsEmptyWhenTenantIdNull() throws SupplyException {
            when(operationRequest.caller()).thenReturn(caller);
