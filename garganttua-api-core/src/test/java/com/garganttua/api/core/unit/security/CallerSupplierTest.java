...
import com.garganttua.api.core.security.authentication.CallerSupplier;
import com.garganttua.core.reflection.IClass;
import com.garganttua.core.runtime.IRuntimeContext;
import com.garganttua.core.supply.SupplyException;

@DisplayName("CallerSupplier Tests")
class CallerSupplierTest {
    ...
    private CallerSupplier supplier;
    ...
    class TypeMetadata {
        ...
        @Test
        @DisplayName("getSuppliedType returns ICaller type")
        void suppliedTypeIsCaller() {
            assertEquals(ICaller.class, supplier.getSuppliedType());
        }
    ...
    class SupplyWithValidInput {
        ...
        @Test
        @DisplayName("returns caller from request")
        void returnsCaller() throws SupplyException {
            when(operationRequest.caller()).thenReturn(caller);

            Optional<ICaller> result = supplier.supply(runtimeContext);

            assertTrue(result.isPresent());
            assertSame(caller, result.get());
        }
