...
public abstract class SpringHttpApiFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (((HttpServletRequest) request).getServletPath().startsWith("/api")) {
			try {
				...
				ServiceResponse responseObject = new ServiceResponse(e.getMessage(), ServiceResponseCode.fromExceptionCode(e));		
	...
	protected abstract HttpServletRequest doFilter(HttpServletRequest request, HttpServletResponse response) throws CoreException ;
