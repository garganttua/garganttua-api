...
@Service
public class SpringSecurityRestSwaggerConfigurer implements ISpringSecurityRestConfigurer {
...
//		}, null);
		...
		this.engine.getAccessRules().stream().filter(accessRule -> {
			...
			if( operation != null && accessRule.getAccess() != ServiceAccess.anonymous)
