...
public class GeoJsonToMongoGeoJsonBinder implements GeoJsonObjectVisitor<GeoJson<?>>{
	...
	public GeoJson<?> visit(Point geoJsonObject) {	
		org.springframework.data.geo.Point point = (org.springframework.data.geo.Point) geoJsonObject.accept(new GeoJsonPointToSpringPointBinder());
