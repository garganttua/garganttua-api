...
import com.garganttua.api.core.security.authorization.RefreshableAuthorization;
...
import com.garganttua.api.commons.security.authorization.IRefreshableAuthorization;
import com.jayway.jsonpath.DocumentContext;
import com.jayway.jsonpath.JsonPath;

@EntityOwned
public class JWTRefreshableAuthorization extends RefreshableAuthorization {
	...
	public JWTRefreshableAuthorization() {
		super();
	}

	public JWTRefreshableAuthorization(byte[] raw) throws CoreException {
		super(raw);
	}

	public JWTRefreshableAuthorization(String uuid, String tenantId, String ownerUuid, List<String> authorities,
    ...
    @Override
    public IRefreshableAuthorization refresh(Date newExpirationDate) {
        return this;
    }
