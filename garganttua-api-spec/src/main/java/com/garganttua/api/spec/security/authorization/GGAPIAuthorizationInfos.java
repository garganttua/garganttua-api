...
public record GGAPIAuthorizationInfos(boolean signable, Constructor<?> completeConstructor,
		...
		GGObjectAddress validateAgainstMethodAddress, GGObjectAddress validateMethodAddress, GGObjectAddress authorizationTypeFieldAddress, GGObjectAddress toByteArrayMethodAddress) {
