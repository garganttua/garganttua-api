...
public class EntityOperation {
	...
	public static EntityOperation custom(String domainName, Method method, Class<?> entity, boolean actionOnAllEntities) {
	...
	private EntityOperation(String domainName, Method method, Class<?> entity, boolean actionOnAllEntities, boolean custom) {
