...
public interface ISecurityEngine {
	...
	ISecurityEngine start() throws CoreException;

	ISecurityEngine stop() throws CoreException;
	
	ISecurityEngine reload() throws CoreException;

	ISecurityEngine flush() throws CoreException;

	ISecurityEngine init() throws CoreException;
