...
public interface IGGAPIRepository<Entity> extends IGGAPIEngineObject {
	...
	List<Entity> getEntities(IGGAPICaller caller, int pageSize, int pageIndex, GGAPILiteral filter, IGGAPISort sort) throws GGAPIException;
	...
	long getCount(IGGAPICaller caller, GGAPILiteral filter) throws GGAPIException;
