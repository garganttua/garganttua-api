...
public class GGAPIEngineRepository extends GGAPIRepository<IGGAPIEntity, IGGAPIDTOObject<IGGAPIEntity>> {
	...
	public GGAPIEngineRepository(IGGAPIDomain<IGGAPIEntity, IGGAPIDTOObject<IGGAPIEntity>> domain, IGGAPIDAORepository<IGGAPIEntity, IGGAPIDTOObject<IGGAPIEntity>> daoRepository) {
		super(domain);
