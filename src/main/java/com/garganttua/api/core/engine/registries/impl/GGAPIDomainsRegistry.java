...
public class GGAPIDomainsRegistry implements IGGAPIDomainsRegistry {
	...
	protected String securityEnabled = "disabled";
...
//						dynamicDomain.db = GGAPIDao.MONGO;
					...
					if( domain.dtos.size() == 0 ) {
						...
						throw new GGAPIDtoException(GGAPICoreExceptionCode.NO_DTO_FOUND, "No class annotated with @GGAPIDto found for entity "+clazz.getName());
					}
