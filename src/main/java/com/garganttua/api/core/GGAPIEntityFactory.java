...
public class GGAPIEntityFactory implements IGGAPIEntityFactory {
	...
	@Override
	@SuppressWarnings("unchecked")
	public <T extends IGGAPIEntity> T getEntityFromRepository(GGAPIDynamicDomain domain, IGGAPICaller caller, Map<String, String> customParameters, String uuid) throws GGAPIEntityException {
		if( domain == null ) {
			throw new GGAPIEntityException("Domain is null");
		}
		if( caller == null ) {
