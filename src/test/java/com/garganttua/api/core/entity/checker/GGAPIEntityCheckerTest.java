...
public class GGAPIEntityCheckerTest {
	...
	public void testEntityWithNoDomain() {
		...
		assertEquals("No domain provided in annotation of entity "+Entity.class.getSimpleName(), exception.getMessage());
	...
	public void testTenantEntityWithNoAnnotatedField() {
		...
		assertEquals("Entity Entity does not have any field value or field annotated with com.garganttua.api.core.entity.annotations.GGAPIEntityTenantId", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testTenantEntityWithFieldAnnotatedOfWrongType() {
		...
		assertEquals("Entity "+Entity.class.getSimpleName()+" has field uuid with wrong type java.lang.Float, should be class java.lang.String", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	...
	public void testTenantEntityWithFieldValueOfWrongType() {
		...
		assertEquals("Entity Entity has field uuid with wrong type class java.lang.Float, should be class java.lang.String", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testOwnerEntityWithNoAnnotatedField() {
		...
		assertEquals("Entity Entity does not have any field value or field annotated with com.garganttua.api.core.entity.annotations.GGAPIEntityOwnerId", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationEntityUuidIsPresentAndFieldHasStringType2() {
		...
		assertEquals("Entity Entity has field uuid with wrong type java.lang.Float, should be class java.lang.String", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationEntityUuidTwice() {
		...
		assertEquals("Entity Entity has more than one field annotated with interface com.garganttua.api.core.entity.annotations.GGAPIEntityUuid", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationDeleteMethodProvider() {
		...
		assertEquals("Entity Entity does not have any field annotated with @GGAPIEntityDeleteMethodProvider", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationDeleteMethodProviderNotGoodType() {
		...
		assertEquals("Entity Entity has field deleteMethod with wrong type long, should be interface com.garganttua.api.core.entity.interfaces.IGGAPIEntityDeleteMethod", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationSaveMethodProvider() {
		...
		assertEquals("Entity Entity does not have any field annotated with @GGAPIEntitySaveMethodProvider", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationSaveMethodProviderNotGoodType() {
		...
		assertEquals("Entity Entity has field deleteMethod with wrong type long, should be interface com.garganttua.api.core.entity.interfaces.IGGAPIEntitySaveMethod", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationSaveMethod() {
		...
		assertEquals("Entity Object does not have method annotated with @GGAPIEntitySaveMethod", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationSaveMethodWrongParam1() {
		...
		assertEquals("Entity Entity has method save but parameter 0 is not of type interface com.garganttua.api.core.IGGAPICaller", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationSaveMethodWrongParam2() {
		...
		assertEquals("Entity Entity has method save but parameter 1 is not of type java.lang.Map<java.lang.String,java.lang.String>", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationSaveMethodWrongParam3() {
		...
		assertEquals("Entity Entity has method save but parameter 2 is not of type Optional<IGGAPISecurity>", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationDeleteMethod() {
		...
		assertEquals("Entity Object does not have method annotated with @GGAPIEntityDeleteMethod", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationDeleteMethodWrongParam1() {
		...
		assertEquals("Entity Entity has method delete but parameter 0 is not of type interface com.garganttua.api.core.IGGAPICaller", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationDeleteMethodWrongParam2() {
		...
		assertEquals("Entity Entity has method delete but parameter 1 is not of type java.lang.Map<java.lang.String,java.lang.String>", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationHiddenableFieldOrAnnotationisPresent() {
		...
		assertEquals("Entity Entity does not have any field value or field annotated with com.garganttua.api.core.entity.annotations.GGAPIEntityHidden", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationHiddenableFieldPresentButNotGoodType() {
		...
		assertEquals("Entity Entity has field hidden with wrong type java.lang.String, should be boolean", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationGeolocalizedFieldOrAnnotationisPresent() {
		...
		assertEquals("Entity Entity does not have any field value or field annotated with com.garganttua.api.core.entity.annotations.GGAPIEntityLocation", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationGeolocalizedFieldPresentButNotGoodType() {
		...
		assertEquals("Entity Entity has field location with wrong type java.lang.String, should be class org.geojson.Point", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationLocationTwice() {
		...
		assertEquals("Entity Entity has more than one field annotated with interface com.garganttua.api.core.entity.annotations.GGAPIEntityLocation", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationEntityIdTwice() {
		...
		assertEquals("Entity Entity has more than one field annotated with interface com.garganttua.api.core.entity.annotations.GGAPIEntityId", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationEntitySAveMethodProviderTwice() {
		...
		assertEquals("Entity Entity has more than one field annotated with interface com.garganttua.api.core.entity.annotations.GGAPIEntitySaveMethodProvider", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationEntityDeleteMethodProviderTwice() {
		...
		assertEquals("Entity Entity has more than one field annotated with interface com.garganttua.api.core.entity.annotations.GGAPIEntityDeleteMethodProvider", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
...
//			@GGAPIEntityRepository
		...
		assertEquals("Entity Entity does not have any field annotated with @GGAPIEntityRepository", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationEntityRepositoryTwice() {
		...
		assertEquals("Entity Entity has more than one field annotated with interface com.garganttua.api.core.entity.annotations.GGAPIEntityRepository", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationEntitySaveMethodTwice() {
		...
		assertEquals("Entity Entity has more than one method annotated with interface com.garganttua.api.core.entity.annotations.GGAPIEntitySaveMethod", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationEntityDeleteMethodTwice() {
		...
		assertEquals("Entity Entity has more than one method annotated with interface com.garganttua.api.core.entity.annotations.GGAPIEntityDeleteMethod", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testAnnotationOwnedAndOwner() {
		...
		assertEquals("Entity TestAnnotationOwnedAndOwner Cannot be owner and owned at the same time", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testSharedEntityWithNoAnnotatedField() {
		...
		assertEquals("Entity Entity does not have any field value or field annotated with com.garganttua.api.core.entity.annotations.GGAPIEntityShare", exception.getMessage());
		assertEquals(GGAPIEntityException.ENTITY_DEFINITION_ERROR, exception.getCode());
	}
	...
	public void testValidationResult() throws GGAPIEntityException, ClassNotFoundException {
		...
		GGAPIEntityInfos expectedResult = new GGAPIEntityInfos (
				"tenants",
				new GGAPIObjectAddress("uuid"), 
				new GGAPIObjectAddress("id"), 
				new GGAPIObjectAddress("saveMethod"), 
				new GGAPIObjectAddress("deleteMethod"), 
				true, 
				true, 
				false, 
				new GGAPIObjectAddress("uuid"),
				...
				new GGAPIObjectAddress("uuid"),
				new GGAPIObjectAddress("superOwner"),
				new GGAPIObjectAddress("save"), 
				new GGAPIObjectAddress("delete"), 
				true, 
				true, 
				new GGAPIObjectAddress("enabled"), 
				true, 
				new GGAPIObjectAddress("location"), 
				true, 
				new GGAPIObjectAddress("surname"), 
				new GGAPIObjectAddress("repository"), 
	...
	@Test
	public void testBusinessMethodsPresence() throws GGAPIEntityException, ClassNotFoundException {
		...
		GGAPIEntityInfos expectedResult = new GGAPIEntityInfos(
				...
				Lists.newArrayList("id", "password"), 
				Lists.newArrayList("id", "location"),
				new GGAPIObjectAddress("afterGet"), 
				new GGAPIObjectAddress("beforeCreate"),
				new GGAPIObjectAddress("afterCreate"), 
				new GGAPIObjectAddress("beforeUpdate"),
				new GGAPIObjectAddress("afterUpdate"), 
				new GGAPIObjectAddress("beforeDelete"),
				new GGAPIObjectAddress("afterDelete"),
				new HashMap<String, String>(), 
				new GGAPIObjectAddress("superTenant"));
